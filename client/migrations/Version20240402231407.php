 ...
 */
final class Version20240402231407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD code_promo_id INT DEFAULT NULL, ADD facture_id INT NOT NULL, ADD total DOUBLE PRECISION NOT NULL');
        $this->addSql('ALTER TABLE cart ADD CONSTRAINT FK_BA388B7294102D4 FOREIGN KEY (code_promo_id) REFERENCES code_promo (id)');
        $this->addSql('ALTER TABLE cart ADD CONSTRAINT FK_BA388B77F2DEE08 FOREIGN KEY (facture_id) REFERENCES facture (id)');
        $this->addSql('CREATE INDEX IDX_BA388B7294102D4 ON cart (code_promo_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_BA388B7294102D4 ON cart');
        $this->addSql('DROP INDEX IDX_BA388B77F2DEE08 ON cart');
        $this->addSql('ALTER TABLE cart DROP code_promo_id, DROP facture_id, DROP total');
