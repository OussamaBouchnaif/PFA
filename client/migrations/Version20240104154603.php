 ...
 */
final class Version20240104154603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE camera (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, nom VARCHAR(100) NOT NULL, description VARCHAR(400) NOT NULL, prix DOUBLE PRECISION NOT NULL, stock SMALLINT NOT NULL, date_ajout DATE NOT NULL, status VARCHAR(50) DEFAULT NULL, INDEX IDX_3B1CEE05BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(50) NOT NULL, adresse VARCHAR(100) DEFAULT NULL, date_inscription DATE NOT NULL, status_compte VARCHAR(20) NOT NULL, ville VARCHAR(20) NOT NULL, pts_fidelite SMALLINT DEFAULT NULL, address_liv_sup VARCHAR(120) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
