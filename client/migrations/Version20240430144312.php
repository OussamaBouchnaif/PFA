 ...
 */
final class Version20240430144312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reduction DROP prix, DROP prix_reduction');
        $this->addSql('ALTER TABLE user ADD ville VARCHAR(20) NOT NULL, ADD phone_number VARCHAR(15) DEFAULT NULL, ADD genre VARCHAR(20) DEFAULT NULL, DROP numtele, CHANGE email email VARCHAR(100) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reduction ADD prix DOUBLE PRECISION NOT NULL, ADD prix_reduction DOUBLE PRECISION NOT NULL');
        $this->addSql('ALTER TABLE user ADD numtele VARCHAR(10) NOT NULL, DROP ville, DROP phone_number, DROP genre, CHANGE email email VARCHAR(70) NOT NULL, CHANGE password password VARCHAR(50) NOT NULL');
    }
}
