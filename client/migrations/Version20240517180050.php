 ...
 */
final class Version20240517180050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog DROP image_coverture');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD image_coverture VARCHAR(255) NOT NULL');
